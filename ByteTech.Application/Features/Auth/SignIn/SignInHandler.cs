...
public class SignInHandler(IUserRepository userRepository, IJwtService jwtService) : IRequestHandler<SignInQuery, BaseResponse>
{
    ...
    public async Task<BaseResponse> Handle(SignInQuery request, CancellationToken cancellationToken)
    {
